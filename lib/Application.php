...
if (!defined('ADMINISTRATOR_BASE')) {
    define('ADMINISTRATOR_BASE', realpath(__DIR__ . '/..'));
}

if (!defined('HORDE_BASE')) {
    /* If Horde does not live directly under the app directory, the HORDE_BASE
     * constant should be defined in config/horde.local.php. */
    if (file_exists(ADMINISTRATOR_BASE . '/config/horde.local.php')) {
        include ADMINISTRATOR_BASE . '/config/horde.local.php';
    } else {
        define('HORDE_BASE', realpath(ADMINISTRATOR_BASE . '/..'));
    }
}
...
/**
 * Administrator application API.
 *
 * This class defines Horde's core API interface. Other core Horde libraries
 * can interact with Administrator through this API.
 *
 * @author    Ralf Lang <lang@b1-systems.de>
 * @category  Horde
 ...
 * @package   Administrator
 */
class Administrator_Application extends Horde_Registry_Application
{
    /**
     */
    ...
    {
        $GLOBALS['injector']->bindFactory('Administrator_Driver', 'Administrator_Factory_Driver', 'create');
    }
